...
Fedora COSMIC Atomic bootc image for my desktop. Built on the ["Unofficial" Bootable Container images](https://quay.io/repository/fedora-ostree-desktops/cosmic-atomic?tab=info).
